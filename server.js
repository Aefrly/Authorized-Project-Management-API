...
app.get('/api/users', requireAdmin, requireAuth, async (req, res) => {
    try {
...
app.post('/api/projects', requireManager, requireAuth, async (req, res) => {
    try {
...
app.put('/api/projects/:id', requireManager, requireAuth, async (req, res) => {
    try {
...
app.delete('/api/projects/:id', requireAdmin, requireAuth, async (req, res) => {
    try {
...
app.post('/api/projects/:id/tasks', requireManager, requireAuth, async (req, res) => {
    try {
...
app.delete('/api/tasks/:id', requireManager, requireAuth, async (req, res) => {
    try {
